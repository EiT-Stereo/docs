...
For å analysere dataene som kommer fra en vibrasjonsmåler, må man ha en ganske avansert og pålitelig software. Dette systemet bruker Fourieranalyse \cite{Fourier} for å skille ut individuelle frekvenser, og et kunnskapsbasert resonneringssystem for å analysere resultatet fra fourieranalysen.
