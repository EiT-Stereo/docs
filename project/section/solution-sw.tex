...
\subsubsection{Resonneringssystem}
Resonneringssystemet er et system for kunskapsanalyse som bruker en klassifikator for å analysere data og klassifisere målingene som enten at en hjulmutter er løs eller ikke.
Resonneringssystemet trenger treningsdata for å korrekt kunne klassifisere nye målinger av systemet. 
Denne dataen burde inneholde en rekke forskjellige observasjoner av mulig data som systemet kan generere, samt en klassifikasjon om det var en løs hjulbolt eller ikke. Dette blir brukt til å trene systemet til å kunne gjenkjenne løse hjulbolter.
