...
For å analysere dataene som kommer fra en vibrasjonsmåler, så må man ha en ganske avansert og pålitelig software. Dette systemet bruker Fourieranalyse for å skille ut individuelle frekvenser, og et kunnskapsbasert resonneringssystem for å analysere resultatet fra fourieranalysen. Fourieranalysen danner lydbilder av hvilke frekvenser som er dominerende i bibrasjonsmålingen.
...
Når analyseringen klassifiserer lydbildet som den mottar som at det finnes en løs hjulmutter, så vil det sende et varsel til det grafiske brukergrensesnittet.
