...
prosjekt kom fram i vårt samarbeid og hva som var læringsutbytte fra situasjonen. (Add en liten sånn: Ble det bedre eller verre.. Kanskje det heller skulle vært på slutten)
...
Todelingen med prosessdel og prosjektdel i faget EiT, med tanke på samholdet i gruppen, har vært ganske tydelig i vår 
gruppe. Christoffer sier følgende om todelingen: 

\begin{quote}``
Jeg føler av vi er en gruppe på fem medlemmer og étt utenfor. Det er veldig kjipt...
''\end{quote} \rightline{{\rm --- Christoffer}}

Det er ikke nødvendigvis unaturlig at en slik todeling oppstår med tanke på at samtlige gruppemedlemmer har mindre 
erfaring med et slikt gruppearbeid og grupperefleksjon. Det kommer også frem i Erlends refleksjoner, som gjengitt under:
...
Opp til dette tidspunktet flere gruppemedlemmer skøvet bort problemet som holdt på å oppstå, men det var også 
...
Misforståelser og ulike synspunkter er ikke uvanlig i en større gruppe. Misforståelser er ikke nødvendigvis så sundt for
et bra samarbeid, men ulikesynspunkter trenger ikke være negativt. Synspunktene til de enkelte kan bidra til en videre
...
denne effektiviteten. Ganske umiddelbart etter en grundig refleksjon rundt problemet ble samholdet i gruppen bedre.
Det hadde gitt effekt prosessdelen i stor grad, mye på grunn av at overgangen fra prosjektarbeid til prosessarbeid 
ble mindre. 
...
Seks gruppemedlemmer kan nå etter et fire måneder langt samarbeid stå sammen når det hele avsluttes.
